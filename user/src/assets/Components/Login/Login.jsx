...
const Login = () => {
  // Only homeowner login allowed now
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setMessage('Account not verified. New OTP sent to your email.');
        toast.addToast('New OTP sent! Redirecting to verification...', 'info');
      ...
      <div style={{
        ...
        <div className="text-center mb-4">
          ...
          <p style={{ color: '#9ca3af' }}>
            Login to your DecorVista account
          </p>
        </div>
