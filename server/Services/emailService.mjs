...
export const sendOTPEmail = async (email, otp) => {
  try {
    ...
    const mailOptions = {
      ...
      to: email,
      subject: '🏠 DecorVista - Verify Your Account',
      html: `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f8fafc;">
          <div style="max-width: 600px; margin: 0 auto; background-color: white; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
            ...
            <div style="background: linear-gradient(135deg, #4f46e5 0%, #7c3aed 50%, #ec4899 100%); padding: 40px 30px; text-align: center;">
              ...
              <p style="color: rgba(255, 255, 255, 0.9); margin: 10px 0 0 0; font-size: 16px;">Your Interior Design Journey Starts Here</p>
            </div>
            
            <!-- Content -->
            <div style="padding: 40px 30px;">
              <div style="text-align: center; margin-bottom: 30px;">
                <h2 style="color: #1f2937; margin: 0 0 15px 0; font-size: 24px;">Welcome to DecorVista!</h2>
                <p style="color: #6b7280; margin: 0; font-size: 16px; line-height: 1.5;">
                  You're just one step away from transforming your space. Please verify your email address to complete your registration.
                </p>
              </div>
              ...
              <div style="background: #fef3c7; border-left: 4px solid #f59e0b; padding: 20px; border-radius: 0 8px 8px 0; margin: 30px 0;">
                ...
                <ul style="color: #92400e; margin: 0; padding-left: 20px; font-size: 14px; line-height: 1.6;">
                  <li>Browse stunning design inspiration</li>
                  <li>Connect with expert interior designers</li>
                  <li>Discover premium home decor products</li>
                  <li>Book personalized consultations</li>
                </ul>
              </div>
              ...
              <div style="margin: 30px 0;">
                ...
                <div style="display: flex; flex-direction: column; gap: 15px;">
                  ...
                  <div style="display: flex; align-items: center; padding: 15px; background: #f9fafb; border-radius: 8px; border-left: 4px solid #4f46e5;">
                    ...
                    <span style="color: #374151; font-size: 14px;">Start your design journey!</span>
                  </div>
                </div>
              </div>
            </div>
...
export const sendPasswordResetEmail = async (email, otp) => {
  try {
    ...
    const mailOptions = {
      from: 'jomob21018@gmail.com',
      to: email,
      subject: '🔐 DecorVista - Password Reset Request',
      html: `
        <!DOCTYPE html>
        <html>
        <head>
          ...
          <div style="max-width: 600px; margin: 0 auto; background-color: white; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
            ...
            <div style="padding: 40px 30px;">
              <div style="text-align: center; margin-bottom: 30px;">
                ...
                <p style="color: #6b7280; margin: 0; font-size: 16px; line-height: 1.5;">
                  A password reset has been requested for your DecorVista account. Use the code below to reset your password.
                </p>
              </div>
            ...
            <div style="background: #f9fafb; padding: 30px; text-align: center; border-top: 1px solid #e5e7eb;">
              <p style="color: #6b7280; margin: 0 0 10px 0; font-size: 14px;">
                <strong>DecorVista</strong><br>
                Secure Interior Design Platform
              </p>
              <p style="color: #9ca3af; margin: 0; font-size: 12px;">
